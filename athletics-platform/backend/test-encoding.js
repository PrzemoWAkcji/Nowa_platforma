...
class EncodingService {
  decodeCsvBuffer(buffer) {
    ...
    // Dla polskich plików, najpierw spróbuj Windows-1250
    const windows1250Data = iconv.decode(buffer, 'windows-1250');

    // Sprawdź czy wynik ma sens (zawiera polskie znaki)
    ...
    // Jeśli Windows-1250 nie daje sensownych wyników, spróbuj UTF-8
