 ...
 *
 * Użycie:
 * 1. Upewnij się że stara baza SQLite istnieje
 * 2. Upewnij się że nowa baza PostgreSQL jest pusta (lub chcesz nadpisać dane)
 * 3. Uruchom: node migrate-data.js
 */

const { PrismaClient } = require('@prisma/client');
const path = require('path');

// Klient dla starej bazy SQLite
...
// Klient dla nowej bazy PostgreSQL (używa DATABASE_URL z .env)
...
async function migrateData() {
  ...
  try {
    ...
    // 9. Migracja drużyn sztafetowych (jeśli istnieją)
    ...
    // 10. Migracja protestów (jeśli istnieją)
