...
import { AddRelayTeamMemberDto, CreateRelayTeamDto, CreateRelayTeamRegistrationDto, CreateRelayTeamResultDto, UpdateRelayTeamDto } from './dto';
export declare class RelayTeamsService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    private checkEditPermissionsAndGetTeam;
    private checkEditPermissions;
    create(createRelayTeamDto: CreateRelayTeamDto, userId: string): Promise<{
        competition: {
            name: string;
    ...
    update(id: string, updateRelayTeamDto: UpdateRelayTeamDto, userId: string): Promise<{
        competition: {
            name: string;
            description: string | null;
            startDate: Date;
    ...
    addMember(teamId: string, addMemberDto: AddRelayTeamMemberDto, userId: string): Promise<{
        athlete: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    fixTeamMembers(teamId: string): Promise<{
        message: string;
        count: number;
        removed?: undefined;
        kept?: undefined;
    ...
    registerForEvent(registrationDto: CreateRelayTeamRegistrationDto, userId: string): Promise<{
        event: {
            name: string;
            type: import(".prisma/client").$Enums.EventType;
            maxParticipants: number | null;
