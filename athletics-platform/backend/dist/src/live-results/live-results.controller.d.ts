...
export declare class LiveResultsController {
    private readonly liveResultsService;
    constructor(liveResultsService: LiveResultsService);
    getLiveResults(token: string, res: Response): Promise<void>;
    getLiveResultsAPI(token: string): Promise<{
        events: {
            isCompleted: boolean;
    ...
    private generateLiveResultsHTML;
