...
exports.LiveResultsController = void 0;
const common_1 = require("@nestjs/common");
const live_results_service_1 = require("./live-results.service");
let LiveResultsController = class LiveResultsController {
    liveResultsService;
    constructor(liveResultsService) {
        this.liveResultsService = liveResultsService;
    }
    async getLiveResults(token, res) {
        try {
    ...
    async getLiveResultsAPI(token) {
        return this.liveResultsService.getLiveResults(token);
    }
    generateLiveResultsHTML(competition) {
...
<body>
    ...
    generateEventHTML(event, isCompleted) {
...
exports.LiveResultsController = LiveResultsController;
__decorate([
...
], LiveResultsController.prototype, "getLiveResults", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LiveResultsController.prototype, "getLiveResultsAPI", null);
exports.LiveResultsController = LiveResultsController = __decorate([
    (0, common_1.Controller)('live-results'),
    __metadata("design:paramtypes", [live_results_service_1.LiveResultsService])
], LiveResultsController);
//# sourceMappingURL=live-results.controller.js.map