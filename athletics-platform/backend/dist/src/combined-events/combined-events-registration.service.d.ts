...
export declare class CombinedEventsRegistrationService {
    private prisma;
    private combinedEventsService;
    private eventsService;
    private registrationsService;
    constructor(prisma: PrismaService, combinedEventsService: CombinedEventsService, eventsService: EventsService, registrationsService: RegistrationsService);
    registerAthleteForCombinedEvent(dto: RegisterAthleteForCombinedEventDto): Promise<{
        results: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    splitCombinedEventIntoSeparateEvents(dto: SplitCombinedEventDto): Promise<{
        combinedEvent: {
            athlete: {
                id: string;
                firstName: string;
    ...
    private createSeparateEventsForCombinedEvent;
    ...
    bulkRegisterAthletesForCombinedEvent(dto: {
        athleteIds: string[];
        competitionId: string;
        eventType: CombinedEventType;
        gender: 'MALE' | 'FEMALE';
    ...
    private getDisciplineEventName;
    private getDisciplineEventType;
    private getDisciplineUnit;
    private getDisciplineDistance;
    private getDisciplineName;
    private getHurdleHeight;
    private getImplementWeight;
    generateIndividualEventsFromCombinedEvents(dto: GenerateIndividualEventsDto): Promise<{
        message: string;
        processedEvents: any[];
        createdEvents: any[];
        createdRegistrations: any[];
