...
export declare class ResultsService {
    ...
    constructor(prisma: PrismaService, athletesService: AthletesService, recordsService: RecordsService);
    ...
    findPersonalBests(athleteId: string): Promise<({
        event: {
            competition: {
                name: string;
                startDate: Date;
    ...
    private checkForRecords;
    private parseResultToSeconds;
    private isResultBetter;
    private getBestNationalRecord;
    private getBestWorldRecord;
}
